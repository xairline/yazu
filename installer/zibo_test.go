...
func TestGetCachedVersions(tt *testing.T) {
	tt.Run("TestGetCachedVersions - ptch", func(t *testing.T) {
		config, tempDir := setup(t)
	...
	tt.Run("TestGetCachedVersions - full", func(t *testing.T) {
		config, tempDir := setup(t)
		t.Logf("tempDir: %s", tempDir)
		defer func() {
			_ = os.RemoveAll(tempDir) // Clean up
	...
	tt.Run("TestGetCachedVersions - full - not exist", func(t *testing.T) {
		config, tempDir := setup(t)
		t.Logf("tempDir: %s", tempDir)
		defer func() {
			_ = os.RemoveAll(tempDir) // Clean up
	...
	tt.Run("TestGetCachedVersions - ptch - not exist", func(t *testing.T) {
		config, tempDir := setup(t)
		t.Logf("tempDir: %s", tempDir)
		defer func() {
			_ = os.RemoveAll(tempDir) // Clean up
